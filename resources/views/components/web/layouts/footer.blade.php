    ...
    <footer>
        ...
        <!-- footer start -->
        <div class="bg-gray bg-no-repeat bg-center bg-cover pt-24" style="background-image:url('{{ asset('images/footer/shape.webp')}} ')">
            <div class="container">
            ...
            <div class="container">
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div class="flex flex-wrap items-center justify-center md:justify-end">
                        <a href="#">
                            <img class="w-full h-full" src="{{ asset('images/logo/payment.webp')}} " alt="payment logo" loading="lazy" width="286" height="23" />
                        </a>
                    </div>
                </div>
    ...
    <div id="modal-addto-cart" class="modal fixed opacity-0 transition-opacity duration-300 ease-linear md:w-11/12 md:max-w-1000 hidden z-50 left-8 right-8 md:left-1/2 top-1/2 transform -translate-y-1/2 md:-translate-x-1/2 p-7 bg-white mx-auto">
        ...
        <div class="md:flex md:flex-wrap">
            <div class="md:mr-5 md:flex-30 mb-5 md:mb-0">
                <img class="w-full" src="{{ asset('images/products/lg/b5.jpg')}} " alt="product image" loading="lazy" width="432" height="480">
            </div>
