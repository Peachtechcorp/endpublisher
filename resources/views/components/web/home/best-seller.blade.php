        ...
        <div class="container">
            ...
            <div class="grid grid-rows-1 grid-flow-col gap-x-4">
                <div class="text-center mb-14">
                    ...
                    <h2 class="font-playfair font-bold text-3xl text-primary md:text-4xl lg:text-xl">Best Seller</h2>
                </div>
            </div>
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="border border-solid border-gray-300 transition-all hover:shadow-product group">
                                            ...
                                            <div class="py-5 px-4">
                                                <h3><a class="block text-base hover:text-orange transition-all" href="#">Nemo troduct esde</a></h3>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="border border-solid border-gray-300 transition-all hover:shadow-product group">
                                            ...
                                            <div class="py-5 px-4">
                                                <h3><a class="block text-base hover:text-orange transition-all" href="#">Any cariations of bassages</a></h3>
                                                <h4 class="font-bold text-md leading-none text-orange mt-3"><del class="font-normal text-sm mr-1 inline-block">$110.00</del>$130.00</h4>
                                            </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="border border-solid border-gray-300 transition-all hover:shadow-product group">
                                            ...
                                            <div id="tab2" class="relative overflow-hidden">
                                                <div class="tab-contents">
                                                    <div id="product4" class="tab-content">
                                                        <img class="w-full h-full" src="{{asset('images/products/lg/b17.jpg')}} " alt="product image" loading="lazy" width="432" height="480" />
                                                    </div>
                                                    <div id="product5" class="tab-content">
                                                        <img class="w-full h-full" src="{{asset('images/products/lg/b5.jpg')}} " alt="product image" loading="lazy" width="432" height="480" />
                                                    </div>
                                                    <div id="product6" class="tab-content">
                                                        <img class="w-full h-full" src="{{asset('images/products/lg/b17.jpg')}} " alt="product image" loading="lazy" width="432" height="480" />
                                                    </div>
                                                    <div id="product7" class="tab-content">
                                                        <img class="w-full h-full" src="{{asset('images/products/lg/product4.webp')}} " alt="product image" loading="lazy" width="432" height="480" />
                                                    </div>
                                                    <div id="product8" class="tab-content">
                                                        <img class="w-full h-full" src="{{asset('images/products/lg/b17.jpg')}} " alt="product image" loading="lazy" width="432" height="480" />
                                                    </div>
                                                </div>
                                            ...
                                            <div class="py-5 px-4">
                                                <h3><a class="block text-base hover:text-orange transition-all" href="#">Bny variations of passages</a></h3>
                                                <h4 class="font-bold text-md leading-none text-orange mt-3"><del class="font-normal text-sm mr-1 inline-block">$110.00</del>$130.00</h4>
                                            </div>
                                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="border border-solid border-gray-300 transition-all hover:shadow-product group">
                                            ...
                                            <div class="py-5 px-4">
                                                <h3><a class="block text-base hover:text-orange transition-all" href="#">Bemo product nides</a></h3>
                                                <h4 class="font-bold text-md leading-none text-orange mt-3"><del class="font-normal text-sm mr-1 inline-block">$110.00</del>$130.00</h4>
                                            </div>
                                        </div>
