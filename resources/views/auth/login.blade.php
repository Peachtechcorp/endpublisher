                ...
                <div class="col-lg-5">
                            ...
                            <form action="{{ route('login') }}" method="POST">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control @error('email') is-invalid @enderror" name="email"
                                        value="{{ old('email') }}" type="email" id="emailaddress" name="email"
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            @if (Route::has('password.request'))
                                <p class="text-muted"> <a href="pages-register.html" class="text-muted ml-1">Forgot your
                                        password?</a></p>
                            @endif
                            <p class="text-muted">Don't have an account? <a href="{{ route('register') }}"
                                    class="text-dark font-weight-medium ml-1">Sign Up</a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
